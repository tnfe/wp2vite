 ...
 * @return content
 */
const doImport = (content, imports) => {
 ...
 * @return content
 */
const doEsBuild = (content, esBuild) => {
...
const doViteConfig = ({ imports, alias, proxy, plugins, define, esBuild, optimizeDeps, rollupOptions }) => {
